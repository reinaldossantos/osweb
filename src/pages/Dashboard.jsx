    ...
    <>
      <Modal title={title} onClose={onClose} size="xl">
        <p style={{ margin: "0 0 12px", fontSize: 12, color: "#9CA3AF" }}>
          Clique em uma O.S. para ver os detalhes.
        </p>
              ...
              <tbody>
                {ordens.map((os, i) => (
                  <tr
                    ...
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.background = isAtrasada(os)
                        ? "#FFF7F7"
                        : i % 2 === 0
                          ? "#fff"
                          : "#FAFAFA")
                  ...
                  >
                    ...
                    <td
                      style={{
                        padding: "12px 14px",
                        color: isAtrasada(os) ? "#DC2626" : "#374151",
                        fontWeight: isAtrasada(os) ? 700 : 400,
                        whiteSpace: "nowrap",
                      }}
                    >
      ...
      {selectedOS && (
        <Modal
          title={`O.S. #${selectedOS.numero_os} — ${selectedOS.titulo}`}
...
function TVMode({ cards, stats, onClose, load }) {
  ...
  const tvCards = cards.filter(
    (c) => !["valorTotal", "valorAbertas", "valorConcluidas"].includes(c._key),
  );
  ...
  return (
    <div className="tv-mode-overlay">
      ...
      >
        {tvCards.map(
          ({ label, value, Icon, bg, icon, color, effect, filtro }) => (
            <div
              key={label}
              onClick={() =>
                filtro && setModalFiltro({ title: label, ordens: filtro() })
              }
            ...
            >
              ...
              >
                <p
                  style={{
                    ...
                    fontSize: 14,
                    color:
                      color === "#fff" ? "rgba(255,255,255,0.8)" : "#6B7280",
                    fontWeight: 700,
                    letterSpacing: 0.3,
              ...
              <p
                style={{
                  margin: 0,
                  fontSize: 11,
                  color: color === "#fff" ? "rgba(255,255,255,0.5)" : "#9CA3AF",
                }}
              >
                ▸ toque para ver OS
              </p>
      ...
      {modalFiltro && (
        <div
          onClick={(e) => e.target === e.currentTarget && setModalFiltro(null)}
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 10000,
          ...
          >
            ...
            >
              <div style={{ color: "#fff", fontSize: 17, fontWeight: 700 }}>
                {modalFiltro.title} — {modalFiltro.ordens.length} OS
              </div>
              <button
            ...
            <div style={{ padding: 16 }}>
              {modalFiltro.ordens.length === 0 ? (
                <p
                  style={{ color: "#64748B", textAlign: "center", padding: 40 }}
                >
                  Nenhuma OS.
                </p>
              ) : (
                modalFiltro.ordens.map((os) => {
                  const cfg =
                    STATUS_CONFIG[os.status] || STATUS_CONFIG.em_aberto;
                  return (
                    <div
                      key={os.id}
                      style={{
...
export default function Dashboard() {
  ...
  const load = async () => {
    ...
    setStats({
      ...
      aguardando_aprovacao: lista.filter(
      ...
      hoje: lista.filter(
        (o) => isHoje(o) && !["concluida", "cancelada"].includes(o.status),
      ).length,
      lancadasHoje: lista.filter((o) => o.data_lancamento?.startsWith(hoje))
        .length,
  ...
  const cards = [
    ...
    },
    {
      ...
      effect: "pulse",
      filtro: () =>
        abrirFiltro("OS Em Aberto", (o) => o.status === "em_aberto"),
    },
    {
      _key: "aguard",
      label: "Aguard. Aprovação",
      value: stats.aguardando_aprovacao,
      Icon: AlertCircle,
      bg: "#F97316",
      icon: "#fff",
      color: "#fff",
    ...
    },
    {
      ...
      effect: null,
      filtro: () =>
        abrirFiltro("OS Em Produção", (o) => o.status === "em_producao"),
    },
    {
      _key: "em_inst",
      label: "Em Instalação",
      value: stats.em_instalacao,
      Icon: Wrench,
      bg: "#F59E0B",
      icon: "#fff",
      color: "#fff",
      effect: null,
      filtro: () =>
        abrirFiltro("OS Em Instalação", (o) => o.status === "em_instalacao"),
    },
    {
      _key: "atraso",
      label: "Em Atraso",
    ...
    },
    {
      ...
      effect: null,
      filtro: () =>
        abrirFiltro("OS Lançadas Hoje", (o) =>
          o.data_lancamento?.startsWith(hoje),
        ),
    },
    {
      _key: "concl",
      ...
      effect: null,
      filtro: () =>
        abrirFiltro("OS Concluídas", (o) => o.status === "concluida"),
    },
    {
      _key: "cancel",
      label: "Canceladas",
      ...
      effect: null,
      filtro: () =>
        abrirFiltro("OS Canceladas", (o) => o.status === "cancelada"),
    },
  ];
  ...
  const valorCards = [
    ...
    },
    {
      ...
      value: fmt(stats.valorConcluidas),
      Icon: TrendingUp,
      bg: "#16A34A",
      filtro: () =>
        abrirFiltro("OS Concluídas", (o) => o.status === "concluida"),
                  ...
                  : c._key === "em_inst"
                    ...
                    : c._key === "atraso"
                      ...
                      : c._key === "hoje"
                        ...
                        : c._key === "lancadas"
                          ? (o) => o.data_lancamento?.startsWith(hoje)
                          : c._key === "concl"
  ...
  return (
    <div>
      ...
      >
        {cards.map(
          ({ label, value, Icon, bg, icon, color, filtro, effect }) => (
            <div
              key={label}
              onClick={filtro}
            ...
            >
              ...
              <p
                style={{
                  margin: "10px 0 0",
                  fontSize: 10.5,
                  color: color === "#fff" ? "rgba(255,255,255,0.6)" : "#9CA3AF",
                }}
              >
                ▸ ver detalhes
              </p>
          ...
          {Object.entries(STATUS_CONFIG).map(([key, cfg]) => {
            ...
            return (
              <div
                ...
                onClick={() =>
                  abrirFiltro(`OS — ${cfg.label}`, (o) => o.status === key)
                }
              >
                <div
                  style={{
                ...
                >
                  <span
                    style={{ fontSize: 12, fontWeight: 600, color: cfg.text }}
                  >
                    {cfg.label}
                  </span>
                ...
                <div
                  style={{ height: 6, background: "#F3F4F6", borderRadius: 3 }}
                >
                  <div
                    style={{
                      height: "100%",
          ...
          {Object.entries(STATUS_CONFIG).map(([key, cfg]) => {
            ...
            return (
              <div key={key} style={{ marginBottom: 14 }}>
                ...
                >
                  <span
                    style={{ fontSize: 13, fontWeight: 600, color: cfg.text }}
                  >
                    {cfg.label}
                  </span>
                  <span
                ...
                <div style={{ flex: 1 }}>
                  {slices.map(({ key, cfg, count, pct }) => (
                    ...
                    >
                      ...
                      />
                      <span style={{ fontSize: 12, flex: 1, color: "#374151" }}>
                        {cfg.label}
                      </span>
                      <span
                        style={{
      ...
      {ultimaOS && (
        <Modal
          title={`O.S. #${ultimaOS.numero_os} — ${ultimaOS.titulo}`}
          onClose={() => setUltimaOS(null)}
          size="lg"
        >
