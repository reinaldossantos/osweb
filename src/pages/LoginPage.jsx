    ...
    return (
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ color: "#64748B", fontSize: 13, margin: "0 0 24px" }}>
          Se o Supabase exigir confirmação de email, verifique sua caixa de
          entrada antes de logar.
        </p>
        <button
          onClick={onVoltar}
          style={{
      ...
      >
        ...
        <div>
          ...
          <p style={{ margin: 0, fontSize: 12, color: "#64748B" }}>
            Conta criada com perfil básico
          </p>
        </div>
      </div>
  ...
  if (enviado)
    return (
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ color: "#64748B", fontSize: 13, margin: "0 0 24px" }}>
          Clique no link do email para redefinir sua senha. Verifique também o
          spam.
        </p>
        <button
          onClick={onVoltar}
  ...
  return (
    <div
      style={{
        ...
        justifyContent: "center",
        background:
          "linear-gradient(145deg,#1A0533 0%,#4C1D95 50%,#7C3AED 100%)",
        padding: 16,
      }}
    >
      <div
      ...
      >
        ...
        {tela === "esqueceu" && (
          <TelaEsqueceuSenha onVoltar={() => setTela("login")} />
        )}
        <p
          style={{
            textAlign: "center",
